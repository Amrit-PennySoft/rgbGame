// Variables //
const gameMessage1 = document.getElementById("message1");
const gameMessage2 = document.getElementById("message2");
...
document.getElementById("start").addEventListener("click", function() {
  document.getElementById("message2").innerHTML = "Please select game difficulty..";
  let difficulty = document.querySelectorAll(".difficulty");
  difficulty.forEach(x=>{
